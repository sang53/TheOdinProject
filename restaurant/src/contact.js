...
function addContent() {
    ...
    appendToContent(parentDiv);
    parentDiv.appendChild(createElement("div", ["contact-sentence"], INFORMATION));
    const contactDiv = createElement("div", ["grid", "contact-div"]);
    contactDiv.appendChild(createElement("div", ["phone-number"], `Phone Number: ${PHONENUMBER}`));
    contactDiv.appendChild(createElement("div", ["email"], `Email: ${EMAIL}`));
    contactDiv.appendChild(createElement("div", ["address"], `Address: ${ADDRESS}`));
